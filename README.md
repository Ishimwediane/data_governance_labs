...
This repository contains the completed labs and reports for the **Data Governance** module.

## Module Components

This module consists of two required labs and a final Capstone project.

### Required Labs

The following labs were completed to build foundational knowledge in data governance and compliance:

#### 1. Data Quality Assessment Report
- **Goal**: Evaluate the quality of a given dataset using key data quality metrics.
- **Key Activities**:
...
### Capstone Project: QuickLoan Mobile Governance Review

The Capstone project represents the culmination of the module, applying all learned concepts to a real-world scenario.

#### Governance Review for QuickLoan Mobile
- **Goal**: Perform a comprehensive data governance review for a mobile lending application.
- **Key Activities**:
    - Analyzed existing data management policies for high-risk financial data.
